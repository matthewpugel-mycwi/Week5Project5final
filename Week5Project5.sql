...
END CATCH
GO
exec ins_borrower 'Winnie', 'Pooh', '2222221234'
go
...
END CATCH
GO
exec upd_borrower 23, 'Eeyore', 'Donkey', 2223331234
...
END CATCH
GO
exec upd_artist 1, 'Jamie', 'Foxx', 1
GO
...
END CATCH
GO
exec ins_disk 'Happy', '2-7-2012', 1, 3, 4
GO
...
END CATCH
GO
exec upd_disk 'Happy', '2-7-2012', 1, 3, 4, 3
GO
