...
/*  --------------------------------------------------------------- */
/*                                                                  */
/*  5/2/2019  Matthew Pugel   Initial deployed. Program accepts input. Checkout is correct   */
/********************************************************************/--%>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceFooter" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:disk_inventoryConnectionString %>" 
        SelectCommand="SELECT [disk_id], disk_name FROM [disk]"></asp:SqlDataSource>
    <br />
    <br />
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:disk_inventoryConnectionString %>" 
        SelectCommand="SELECT [borrower_id], fname, lname FROM [borrower]"></asp:SqlDataSource>
    <br />
